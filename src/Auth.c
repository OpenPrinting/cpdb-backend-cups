...
static enum MHD_Result handle_request(void *cls, struct MHD_Connection *connection,
    ...
    if (strcmp(url, "/callback") == 0) {
        ...
        if (strcmp(method, "GET") == 0) {
                ...
                if (curl) {
                    ...
                    if (res != CURLE_OK) {
                        ...
                        if (json_object_object_get_ex(json_response, "access_token", &json_access_token)) {
                            ...
                            FILE *token_file = fopen("access_token.txt", "w");
                            ...
                            if (token_file) {
                                ...
                                g_warning("Failed to open access_token.txt for writing.");
                            }
                        } 
                        else {
            ...
            const char *response_html = "<html><body><h1>Authentication successful! You can close this window.</h1></body></html>";
